...
class Payment {
   ...
   * @param {object} query - https://pay.weixin.qq.com/wiki/doc/api/external/jsapi.php?chapter=9_15&index=10 for more info
   * @return {Promise}
   */
  queryexchagerate(query) {
    return this.simpleRequest(this.paymentUrls.QUERY_EXCHANGE_RATE, query).catch(
      reason => {
